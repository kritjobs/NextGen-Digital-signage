...
export const INITIAL_SCREENS: DigitalScreen[] = [
  {
    ...
    group: 'HQ Reception',
    tags: ['lobby', 'entrance', '4k', 'reception'],
    location: 'Building A - Ground Floor Entrance',
    orientation: 'landscape',
    resolution: '3840x2160 (4K)',
    status: 'online',
    lastHeartbeat: new Date().toISOString(),
    ipAddress: '', // จริง: server เก็บจาก connection ตอน pair/heartbeat (REQ-001)
    macAddress: '',
    storageUsageMb: 2450,
  ...
  },
  {
    ...
    tags: ['elevator', 'portrait', 'executive'],
